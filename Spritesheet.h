...
public:
	Spritesheet(/*const char**/ SDL_Texture* s, unsigned int nrcadre, float poz_x, float poz_y, float angel) : Textura(s,poz_x, poz_y,angel),GameObject(poz_x,poz_y,angel) {
		numar_cadre = nrcadre;
		cadru_curent = 0;
